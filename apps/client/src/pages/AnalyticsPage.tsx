...
import { HealthScore } from "@/features/dashboard/components/health-score";
import { YearlyForecast } from "@/features/dashboard/components/yearly-forecast";
    ...
    return (
      <PageTransition>
        <div className="space-y-6">
          <PageHeader
            title="Analytics"
            description="Insights into your subscriptions."
          />
    ...
    <PageTransition>
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <Card className="p-6">
            <HealthScore subscriptions={data.subscriptions} />
          </Card>
        </div>
        ...
        <Card>
          <div className="p-6 pb-2">
            ...
            <p className="text-sm text-muted-foreground">
              Next 12 months (
              {formatCurrencyCompact(data.monthlyTotal, data.primaryCurrency)} /
              month)
            </p>
          </div>
          <div className="px-6 pb-6">
